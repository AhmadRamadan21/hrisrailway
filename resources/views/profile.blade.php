        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 text-center p-4">
                <div class="card-body">
                    ...
                    @if (auth()->user()->foto)
                        <img src="{{ asset(auth()->user()->foto) }}" id="avatarPreview" alt="Profile Photo"
                            class="rounded-circle mx-auto mb-3 shadow-sm object-fit-cover"
                            style="width: 100px; height: 100px; border: 3px solid #e2e8f0;">
                    @else
                        <div id="avatarInitials" class="avatar-circle mx-auto mb-3 shadow-sm"
                            style="width: 100px; height: 100px; font-size: 32px; background: #2563eb;">
                            {{ strtoupper(substr($user->name ?? $user->username, 0, 2)) }}
                        </div>
                        <img src="" id="avatarPreview" alt="Profile Photo"
                            class="rounded-circle mx-auto mb-3 shadow-sm object-fit-cover d-none"
                            style="width: 100px; height: 100px; border: 3px solid #e2e8f0;">
                    @endif
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="input-group input-group-sm mb-2 px-3">
                            <input type="file" name="foto" id="fotoInput"
                                class="form-control rounded-start-pill @error('foto') is-invalid @enderror"
                                accept=".jpg,.jpeg,.png" required style="font-size: 11px;">
                            <button class="btn btn-outline-primary rounded-end-pill" type="submit"
                                style="font-size: 11px;"><i class="bi bi-upload"></i> Upload</button>
                        </div>
                        @error('foto')
        ...
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-body p-4 pt-0">
                    ...
                    {{-- SECTION 1: DATA AKUN --}}
                    <h6 class="fw-bold text-primary small text-uppercase mb-3" style="letter-spacing: 0.5px;">Data Akun
                        (Sistem)</h6>
                    ...
                    <h6 class="fw-bold text-primary small text-uppercase mb-3" style="letter-spacing: 0.5px;">Data Karyawan
                        Terkait</h6>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <div class="p-3 bg-light rounded-3">
                                    ...
                                    <span
                                        class="fw-semibold text-dark font-monospace">{{ $karyawan->no_pegawai ?? '-' }}</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="p-3 bg-light rounded-3">
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ optional($karyawan->divisi)->nama_divisi ?? '-' }}</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="p-3 bg-light rounded-3">
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ optional($karyawan->jabatan)->nama_jabatan ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="alert alert-warning border-0 rounded-3 d-flex align-items-center gap-3 p-3 mb-0"
                            role="alert">
                            <i class="bi bi-exclamation-triangle-fill fs-4 text-warning"></i>
                            <div>
                                <div class="fw-bold">Akun Belum Terhubung</div>
                                <div class="small">Akun Anda belum dikaitkan dengan data karyawan. Silakan hubungi
                                    Administrator untuk melakukan sinkronisasi data.</div>
                            </div>
                        </div>
                    @endif
